...
const REGISTRATION_ENTRIES: readonly RegistrationEntry[] = [
  ...
  // Resumable host-driven crawl jobs (#886)
  { tools: ['crawl_start'], register: registerCrawlStartTool },
  { tools: ['crawl_status'], register: registerCrawlStatusTool },
  { tools: ['crawl_cancel'], register: registerCrawlCancelTool },
