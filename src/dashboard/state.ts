...
export class DashboardState {
  ...
  recordToolEnd(
    ...
    // An MRTR input_required response completes one protocol round without
    // completing or failing the logical tool operation; the client retries
    // it as a new call, so it counts toward neither bucket.
