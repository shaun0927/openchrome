...
export const OPEN_BENCHMARK_ISSUES: readonly BenchmarkIssueReadiness[] = [
  ...
  },
  {
    ...
    status: 'partial',
    measurementReadiness: 'diagnostic_or_smoke_only',
    evidence: ['The real-world task-completion runner emits a local deterministic library × task matrix with final postcondition evidence and diagnostic-only claim eligibility.'],
    ...
    nextActions: ['Add repeated live/recorded-real task-completion rows and connect reliability stress signals to these final postcondition contracts.'],
  },
  {
    issue: 1310,
